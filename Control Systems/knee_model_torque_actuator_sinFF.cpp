...
int main() {
	try {
		...
		double amplitude = ...; // Amplitude of the sinusoidal signal
		double frequency = ...; // Frequency of the sinusoidal signal

		// Create the sinusoidal control function and add it to the actuator
		torqueActuator->setControlFunction(Sinusoidal(amplitude, frequency, 0.0, 0.0));
